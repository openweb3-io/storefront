...
import { formatMoney, getHrefForVariant, serverToBase64URL } from "@/lib/utils";
	...
	return {
		...
		openGraph: {
			url: process.env.NEXT_PUBLIC_STOREFRONT_URL
				? process.env.NEXT_PUBLIC_STOREFRONT_URL + `/${params.channel}/cart`
				: undefined,
		},
		other: {
			["og:params"]: serverToBase64URL(`/${params.channel}/cart`),
		},
	};
}
