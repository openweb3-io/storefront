export const apiErrorMessages = {
	...
	userAddressCreateInvalidError: "Invalid address data provided",
	userAddressCreateRequiredError: "Required address fields are missing",
	userAddressCreateUniqueError: "Address already exists",
